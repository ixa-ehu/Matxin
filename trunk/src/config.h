...
class config {
 ...
 public:
	...
	*cf_Usubcat,  *cf_Urules, *cf_Utripletes, *cf_first_case,
	...
	DoTrace=false;
      ...
      else if (string(InputF)=="parsedeli") InputFormat = PARSEDELI;
      else if (string(InputF)=="dep") InputFormat = DEP;
      else if (string(InputF)=="depeli") InputFormat = DEPELI;
      ...
      else if (string(OutputF)=="parsedeli") OutputFormat = PARSEDELI;
      else if (string(OutputF)=="depeli") OutputFormat = DEPELI;
 ...
 private:
    ...
    void PrintHelpScreen(){
      ...
      cout<<"--outf string          Output format (plain,token,splitted,morfo,tagged,parsed,parsedeli,dep,depeli)"<< endl;
