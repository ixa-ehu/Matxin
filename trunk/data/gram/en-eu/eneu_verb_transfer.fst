...
define IMInf	     [ "[" [ {V} [{V}|{D}|{H}|{B}] {0} ] KarakPlus* "]" ] ;
define IMPar	     [ "[" [ {V} [{V}|{D}|{H}|{B}] {N} ] KarakPlus* "]" ] ;
...
define IMJok	     [ "[" [{V} [{V}|{D}|{H}] [{0}|{D}|{Z}] | {VB}[{M}|{R}|{Z}] | {VBD} [{R}|{Z}] | {VM} ] KarakPlus* "]" ];
...
define TransTrinkArr [ 
       [  {AspN} ?* "/" {AdL}  -> "[ADT]"	||  ?* [ VB [M|R|Z] | VBD [R|Z] | V [V|H] [0|Z|D] ] ?* AdTrinkoa ?* XXX {AR} %)  ?*  _ ?* ]
];
...
define TransAspNArr [ 
       [ {AspN} -> "EZBU" ||  ?* [ V [V|H] [0|Z] | VB [M|R|Z] ]		?*  XXX {AR} %) ?* _ ?*  ] 
       .o.##|
       [ {AspN} -> "EZBU" ||  ?* [ VD [0|Z] ]				?*  XXX {AR} [{DO}]* %) ?* _ ?*  ] 
       .o.##|
       [ {AspN} -> "BURU" ||  ?* [ VVD | VDD | VHD | VBD [R|Z] ] ?* VV0*	?*  XXX {AR} [{DO}]* %) ?* _ ?*  ] 
       .o.##|
...
define TransDenMod [	
	...
	.o.##|
        [ {DenMod}    -> "[A1]"	||   ?* [ V [V|D|H] [0|Z] | VB [M|R|Z|0] ]	?*  XXX {AR} [{LAG} | {WIL}]* %) ?*  _ ?* ] 
	.o.##|
        [ {DenMod}    -> "[A1]"	||   ?* [ VD [0|Z] ]				?*  XXX {ARDO} %) ?*  _ ?* ] 
	.o.##|
	[ {DenMod}    -> "[B1]"	||   ?* [ VVD | VDD | VHD | VBD [R|Z] ]		?*  XXX 		?*  _ ?* ] 
] ;
